import pygame
from info import *
from entity import Entity,obj_list
...
# update
    def update(self):
        ...
        #self.velocity = (self.get_velocity_axis(0),self.get_velocity_axis(1))
        #print(self.apply_velocity(1))
        self.pos = (self.pos[0] + self.apply_velocity(0),self.pos[1] + self.apply_velocity(1))
    ...
    def add_force(self,f):
        acc_x = f[0]/self.mass
        acc_y = f[1]/self.mass
        self.velocity = (self.velocity[0] + (acc_x*self.deltaTime),self.velocity[1] + (acc_y*self.deltaTime))
