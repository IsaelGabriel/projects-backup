...
class Game:
    def __init__(self,render_surface):
        ...
        self.scene_list = {
            'Scene 1': [
                ...
                (None,"Solid",(window_size.x/2-250,window_size.y*0.75),(500,50),"on"),
                (None,"Solid",(0,window_size.y*0.75-50),(200,50),"on"),
                (None,"Solid",(window_size.x-150,window_size.y*0.75-50),(150,50),"on"),
                (None,"Solid",(window_size.x-150,window_size.y*0.50-50),(150,50),"on"),
                (None,"Trap",(window_size.x/2-250+50,window_size.y*0.75-(50/4)),(50,50/4),"trigger")
            ]
        }
    ...
    def add_object(self,id,type,pos,size,collision):
        ...
        if type == "Player":
            ...
            self.obj_dict[id] = Trap(id,pos,size,collision)
